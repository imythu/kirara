...
| 系统 | 安装包 | 使用方式 |
| --- | --- | --- |
| Windows x64 | `kirara-2.3.1-x86_64-pc-windows-msvc-setup.exe` | 运行安装程序，完成后从开始菜单打开 Kirara |
| macOS Apple Silicon | `kirara-2.3.1-aarch64-apple-darwin.dmg` | 打开映像，将 Kirara 拖入“应用程序”，然后打开 |
